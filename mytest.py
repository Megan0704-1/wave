...
mfma_variant_0 = (tkw.MMAType.RDNA4_WAVE32_F16_16x16x16_F16, ) * 2
...
write_files="./wmma_f16_16x16x16_f16.mlir"
with open(write_files, "w") as fh: fh.write(attention.asm)


shape = (64,64,64)
mfma_variant_1 = tkw.MMAType.RDNA4_WAVE32_f16_16x16x16_F16
